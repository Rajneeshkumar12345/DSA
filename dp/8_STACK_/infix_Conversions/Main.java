...
public static void main(String[] args) throws Exception {
    ...
    for(int i = 0; i<n; i++){
        ...
        if(ch == '('){
            ...
            optr.pop();  // process k baad optr ko pop kro
        }
        else if(isOptr(ch)){
            ...
            optr.push(ch);  // Jo operator waiting me tha usko optr me push kro
        }
    }
    
    while(optr.size() != 0){  // if last me koi operator bacha ho 
        char operator = optr.pop();
        String postV2 = postfix.pop();
        String postV1 = postfix.pop();
